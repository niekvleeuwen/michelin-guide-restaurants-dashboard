                                ...
                                [
                                        ...
                                        [
                                            dbc.Col(
                                                [
                                                    ...
                                                    dcc.Dropdown(
                                                        id="location-preference", placeholder="Enter city or country"
                                                    ),
                                                ],
                                                width=12,
                                            )
                                        ...
                                        [
                                            dbc.Col(
                                                [
                                                    ...
                                                    dcc.Dropdown(
                                                        id="cuisine-preference", placeholder="Enter preferred cuisine"
                                                    ),
                                                ],
                                                width=12,
                                            )
                                    ...
                                    dbc.Row(
                                        [
                                            dbc.Col(
                                                [
                                                    dbc.Label("Describe what kind of restaurant you are looking for."),
                                                    dbc.Textarea(
                ...
                [
                    ...
                    dbc.CardBody(
                        [
                            ...
                            dbc.Spinner("No results yet.", id="recommendations-form-output", color="primary"),
                        ]
                    ),
                ],
                className="shadow-sm",
...
@callback(
    [
        Output("location-preference", "options"),
        Output("cuisine-preference", "options"),
    ],
    Input("store", "data"),
)
@df_from_dict
def fill_options(df: pd.DataFrame) -> dict:
    location_options = (
    ...
    return sorted(location_options), sorted(list(set(cuisine_options)))
